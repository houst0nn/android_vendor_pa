...
# Lollipop bootani
ifneq ($(filter pa_bacon,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
        vendor/pa/prebuilt/bootanimation/bootanimation.zip:system/media/bootanimation.zip
endif

# PA XXHDPI Devices
ifneq ($(filter pa_d800 pa_d801 pa_d802 pa_d803 pa_d851 pa_honami pa_find5 pa_find7 pa_find7u pa_hlte pa_i9500 pa_jflte pa_ls980 pa_m7 pa_m7spr pa_m7vzw pa_m8 pa_n1 pa_odin pa_sirius pa_vs980 pa_yuga,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
